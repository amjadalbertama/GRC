        ...
        <div id="main-content" class="col with-fixed-sidebar bg-light pb-5">
            <nav aria-label="breadcrumb" class="no-side-margin bg-light mb-2">
                <ol class="breadcrumb mb-0 rounded-0 bg-light">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Compliance Fulfillment per Business Process</li>
                </ol>
            </nav>
                                ...
                                <table class="table table-bordered table-sm border bg-white text-center">
                                    <thead class="thead-main text-nowrap">
                                        <tr class="text-uppercase font-11">
                                            <th rowspan="2" class="pl-3 align-middle">Capabilities</th>
                                            <th rowspan="2" class="pl-3 align-middle">Compliance Obligat</th>
                                            <th colspan="4">Compliance Status</th>
                                            <!-- <th>header</th>
                                            <th>title</th>
                                            <th>Action</th> -->
                                        </tr>
